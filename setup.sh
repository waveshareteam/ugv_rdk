...
sudo apt update
#sudo apt upgrade -y
sudo apt install -y cron libopenblas-dev libatlas3-base python3-opencv portaudio19-dev
...
echo "Setup completed. Please to reboot your Rdk for the changes to take effect."
